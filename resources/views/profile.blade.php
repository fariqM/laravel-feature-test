    ...
    <div class="user">
      ...
      <div class="user__info">
        ...
        <span class="user__info__name">
          ...
          <span class="first" id="metu">Adam</span>
        ...
        <div class="artist__header">
          ...
          <div class="artist__info">
            ...
            <div class="artist__info__meta">
              ...
              <div class="artist__info__type">My Profile</div>



              <div class="artist__info__name">{{ $user->username }}</div>
              <div class="artist__info__type">{{ $user->email }}</div>
          ...
          <div class="artist__listeners">
            ...
            <div class="artist__listeners__count">{{ $user->address }}</div>

            <div class="artist__listeners__label">{{ $user->tgl }}</div>
